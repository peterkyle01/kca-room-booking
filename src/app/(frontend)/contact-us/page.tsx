    ...
    <div className="max-w-2xl mx-auto min-h-screen flex justify-center items-center px-2">
      <div>
          ...
          {isSubmitted ? (
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full flex justify-center items-center gap-2 py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-sky-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          ...
          <a href="mailto:support@example.com" className="text-sky-600 hover:text-sky-500">
            support@kca-room-booking.com
          </a>
        </div>
      </div>
    </div>
